...
def llava_add_act_qaunt(model, args):
    if args.quant_llm:
        add_actquant(
            model.model.language_model.model,
            args.act_per_tensor,
    ...
    if args.quant_visual_clip:
        ...
        #     model.model.visual.patch_embed.proj, args.act_per_tensor
        # )
        add_actquant(model.model.vision_tower.vision_model.encoder.layers, args.act_per_tensor)

    if args.quant_cross_attention:
        add_actquant(model.model.multi_modal_projector, args.act_per_tensor)
