...
"""
quant with turboquant

CUDA_VISIBLE_DEVICES=0 python mme/quant_llava.py \
...
def llava_turbo_kv_infer(vlm_llava):
    ...
    raw_image = Image.open("/home/ecnu01/workspace/sure_quant/sample_img/cat2.jpg")
    
    engine = LLaVAInferEngine(vlm_llava.model, vlm_llava.processor)
    res = engine.generate(raw_image, messages, max_new_tokens=128)
    print(">>>>>>>>> result: ")
    print(res)
